            ...
            <div className={`${cb}__flex`}>
                <Fade>
                    <div>
                        <div className={`${cb}__image-wrapper`}>
                            <img className={`${cb}__image`} src={image} alt='' />
                        </div>
                ...
                <div className={`${cb}__text`}>
                    <Fade bottom>
                        ...
                        <p className={`${cb}__emphasized`}><strong>Note:</strong> We recommend you book early! There is a convention during the wedding weekend at the KI Convention Center in Downtown Green Bay which will reduce the availability of rooms.</p>
                        <p>Some options include:</p>
                    </Fade>
                    <Fade bottom cascade>
                        <ul className={`${cb}__list`}>
                            <li><a href='https://www.marriott.com/hotels/travel/grbak-hotel-northland-autograph-collection/?scid=bb1a189a-fec3-4d19-a255-54ba596febe2'>Hotel Northland, Autograph Collection</a>: This will be home base for all things wedding! Ceremony AND reception will be held in the Crystal Ballroom on the second floor. A room block has been set aside and will be filled on a first-come, first-served basis. Established in 1924, the Northland was recently acquired by Marriott and was restored and reopened in 2019 after a long closure. We highly recommend booking your room here! </li>

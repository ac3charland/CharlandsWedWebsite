...
import image from '../../images/things0.jpg'
                ...
                <div className={`${cb}__text`}>
                    <Fade bottom cascade>
                        <ul className={`${cb}__list`}>
                            ...
                            <li><a href='http://www.baybeachwildlife.com/'>Bay Beach Wildlife Sanctuary</a> is located walking distance form Bay Beach Amusement Park. It’s completely free and provides miles of walking trails and educational nature centers that are completely free! At the main building, you can purchase bags of corn for $1.00 each and feel the ducks and geese that call this place home.</li>
